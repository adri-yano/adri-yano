...
I'm a Software Engineering student who designs systems end-to-end — from database schema to deployed API to the UI on top of it — and then stress-tests them to understand what makes them solid.

My work sits across three areas:

- 🏗 **Full-Stack & Backend Engineering** — building production-style apps and REST APIs with clean architecture (Java, Spring Boot, React, Next.js, PostgreSQL)
- ☁ **Cloud, Linux & DevOps** — containerizing and deploying services with Docker, exploring Kubernetes and AWS
- 🔐 **Cybersecurity Fundamentals** — learning the security side of the systems I build, from JWT auth to basic network analysis
...
| Project | Description |
|---|---|
| 🛒 **Procurement & Resource Management System (ERP)** | Enterprise-style ERP built with Spring Boot + React |
| 📱 **Social Media Platform** | Full-stack app with auth, feeds, and real-time features |
| 🌐 **Personal Portfolio** | Personal site showcasing projects and skills |
| 💼 **Enterprise Spring Boot REST APIs** | Production-style backend APIs with JWT security |

</div>

> Replace this table with `origin_repo_url` links once you decide which repos to pin — GitHub also lets you "pin" repos directly on your profile, which is worth doing alongside this table.
...
✔ Java · React · Tailwind CSS · Next.js

🟨 Spring Boot · PostgreSQL · Docker · Linux · JWT Auth

⬜ Microservices · Redis · RabbitMQ · CI/CD · Kubernetes · AWS · Terraform
██████████████████████████████████
```
